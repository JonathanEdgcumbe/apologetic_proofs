...
public class GodSpirit extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addNormalText("Another attribute of God is that He is spirit. In John 4:24 (ESV), " +
                ...
                " but He is a spiritual being.<br>" +
                "<br>" +
                ...
                " from making any images in an attempt to represent God. <br>" +
                "<br>" +
                "Exodus 20:4 (ESV) says:");
        addBlockQuote("You shall not make for yourself a carved image, or any likeness of anything" +
                " that is in heaven above, or that is in the earth beneath, or that is in the" +
                " water under the earth.<br>");
        addNormalText("I take this verse to imply that, because God is not a physical object, if you " +
                "try to represent Him through physical objects, then you would simply" +
                " misrepresent who He is.<br>" +
                "<br>" +
                ...
                "rather, it refers to God’s awareness of everything that is happening.<br>" +
                "<br>" +
